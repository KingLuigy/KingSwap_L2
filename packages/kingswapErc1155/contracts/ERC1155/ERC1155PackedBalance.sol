...
contract ERC1155PackedBalance is IERC1155, ERC165 {
    ...
    internal
    {
        ...
        require(nTransfer == _amounts.length, "ERC1155:INVALID_ARRAYS_LENGTH");
    ...
    public override view returns (uint256[] memory)
    {
        ...
        require(n_owners == _ids.length, "ERC1155:INVALID_ARRAY_LENGTH");
    ...
    internal pure returns (uint256 newBinValues)
    {
        ...
        if (_operation == Operations.Add) {
            ...
            require(newBinValues >= _binValues, "ERC1155:OVERFLOW.1");
            require(
