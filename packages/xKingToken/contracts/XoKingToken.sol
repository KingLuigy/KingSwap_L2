 ...
 */
contract XoKingToken is Eip1967Proxied, Erc677BridgeToken, DelegatableCheckpoints, NetworkParams, IMetaTxsSupport {

    string public constant version = "1";

    /// @dev The symbol of the token
    string private constant _symbol = "xo$KING";

    /// @dev The name of the token
    string private constant _name = "xo$KING Token";
