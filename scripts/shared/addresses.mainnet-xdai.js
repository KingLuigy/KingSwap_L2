module.exports = {
  ...
  // AMB-extension contract (aka "mediator") for ERC20 (old $KING) on the layer1 chain
  ...
  // AMB-mediator contract (aka "mediator") for ERC20 (old $KING) on the side-chain
  ...
  ambErc1155ExtAddress: '0x0000000000000000000000000000000000000000', // proxy
  ...
  xAmbErc1155ExtAddress: '0x0000000000000000000000000000000000000000', // proxy
  ...
  // x$KING token on the side-chain (replica of the OLD $KING)
